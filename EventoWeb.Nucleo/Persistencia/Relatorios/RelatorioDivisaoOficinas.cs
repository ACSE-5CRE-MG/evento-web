        ...
        public Stream Gerar(IEnumerable<Oficina> oficinas, IList<AtividadeInscricaoOficinasCoordenacao> coordenadores)
        {
            ...
            using (var documento = new Document(pdfDocumento, PageSize.A4))
            {
                ...
                foreach (var oficina in oficinas)
                {
                    ...
                    cabecalho.Add("Oficina: " + oficina.Nome);
                    ...
                    cabecalhoTotais.Add("Participantes: " + oficina.Participantes.Count().ToString());
                    ...
                    foreach (var participante in oficina.Participantes.OrderBy(x => x.Pessoa.Nome))
                    {
